...
public class OptionEnum<E extends Enum<E>> implements IOption<E> {
    ...
    public OptionEnum(NBTTagCompound tag, String key, Class<E> enumClass, E dval, boolean enabled) {
        this.tag = tag;
        this.key = key;
    ...
    public OptionEnum(NBTTagCompound tag, String key, Class<E> enumClass, E dval) {
    ...
    public void set(E val) {
        ...
        value = val;
        tag.setString(key, getValueString());
    }
